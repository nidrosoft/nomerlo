...
const sortOptions = [
    ...
    { id: "units-high", label: "Most Units" },
    { id: "units-low", label: "Fewest Units" },
    { id: "revenue-high", label: "Highest Revenue" },
    { id: "revenue-low", label: "Lowest Revenue" },
];
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-4">
                ...
                <p className="text-secondary">
                    ...
                    <span className="font-medium text-primary">{totalResults}</span> properties
                </p>
            </div>
